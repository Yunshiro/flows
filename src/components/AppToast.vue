...
.toast--success { background: var(--tag-green-bg); color: var(--tag-green-text); border: 1px solid rgba(var(--accent-rgb), 0.18); }
.toast--error { background: var(--tag-red-bg); color: var(--tag-red-text); border: 1px solid rgba(198, 92, 76, 0.22); }
.toast--info { background: var(--tag-blue-bg); color: var(--tag-blue-text); border: 1px solid rgba(86, 154, 169, 0.22); }
